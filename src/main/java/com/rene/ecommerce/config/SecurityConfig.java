...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	private static final String[] PUBLIC_MATCHER = {
			"/swagger-ui/****","/v3/api-docs/**" ,"/create/**", "/forgot","/create/client","/create/seller"
	};
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/update/seller").hasAuthority("ROLE_SELLER").anyRequest().authenticated();
